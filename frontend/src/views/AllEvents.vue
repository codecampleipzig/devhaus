<template>
  <div>
    <section class="view-events">
      ...
      <router-link :to="{ name: 'UserEvents' }">Your Events</router-link>
    </section>
    ...
    <section class="hidden">
      ...
      <header class="flex items-center justify-between mb-2">
        ...
        <div class="flex flex-row">
          <router-link class="button text-2xl mt-0 mr-4" :to="{ name: 'CreateEvent' }">
            +
          </router-link>
        </div>
      </header>
...
export default {
  ...
  computed: {
    ...
    sortedEvents() {
      ...
      return events.filter(this.eventFilter);
    },
